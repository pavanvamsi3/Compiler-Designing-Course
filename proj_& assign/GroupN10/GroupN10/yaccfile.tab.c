...
{
       0,     0,     3,     7,    11,    13,    15,    16,    19,    20,
      22,    24,    25,    31,    32,    37,    40,    41,    48,    51,
      54,    57,    58,    60,    61,    64,    65,    67
};
...
static const yytype_int8 yyrhs[] =
{
      ...
      -1,     3,    -1,    10,    -1,    -1,    21,    22,    -1,    -1,
      14,    -1,    23,    -1,    -1,     4,    11,    24,    31,     5,
      -1,    -1,    15,    26,    31,    27,    -1,     7,     8,    -1,
      -1,     8,    28,    29,     9,    30,     8,    -1,    29,    13,
      -1,    29,    22,    -1,    29,    25,    -1,    -1,    11,    -1,
      -1,    31,    32,    -1,    -1,    11,    -1,    11,     6,    12,
      -1
};
...
{
       0,    17,    17,    20,    24,    28,    29,    32,    33,    36,
      37,    40,    40,    44,    44,    50,    51,    51,    55,    56,
...
{
       0,    16,    17,    18,    19,    20,    20,    21,    21,    22,
      22,    24,    23,    26,    25,    27,    28,    27,    29,    29,
...
{
       0,     4,     0,     0,     6,     1,    13,     8,     5,     8,
      25,     2,     3,     0,     0,     9,     7,    10,     0,    16,
      26,    14,    24,    11,    15,    21,     0,    25,     0,    27,
       0,    23,    18,    19,    20,    12,    22,     0,    17
};
...
/* Line 1792 of yacc.c  */
#line 28 "yaccfile.y"
    {printf("<?XML-ENCODING %s?>\n",(yyvsp[(1) - (1)].s)); free((yyvsp[(1) - (1)].s));}
    break;

  case 9:
/* Line 1792 of yacc.c  */
#line 36 "yaccfile.y"
    {printf("%s", (yyvsp[(1) - (1)].s));}
    break;

  case 11:
/* Line 1792 of yacc.c  */
#line 40 "yaccfile.y"
    {printf("\n<?XML-ATT %s", (yyvsp[(2) - (2)].s));}
    break;
...
/* Line 1792 of yacc.c  */
#line 44 "yaccfile.y"
    {printf("\n<%s", (yyvsp[(1) - (1)].s)); free((yyvsp[(1) - (1)].s));}
    break;
...
/* Line 1792 of yacc.c  */
#line 55 "yaccfile.y"
    {printf("%s", (yyvsp[(2) - (2)].s)); free((yyvsp[(2) - (2)].s));}
    break;
...
/* Line 1792 of yacc.c  */
#line 69 "yaccfile.y"
    {printf(" %s", (yyvsp[(1) - (1)].s)); free((yyvsp[(1) - (1)].s));}
    break;

  case 27:
/* Line 1792 of yacc.c  */
#line 70 "yaccfile.y"
    {printf(" %s=%s", (yyvsp[(1) - (3)].s), (yyvsp[(3) - (3)].s)); free((yyvsp[(1) - (3)].s)); free((yyvsp[(3) - (3)].s));}
    break;


/* Line 1792 of yacc.c  */
#line 1465 "yaccfile.tab.c"
      default: break;
    }
